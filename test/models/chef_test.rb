...
class ChefTest < ActiveSupport::TestCase
    ...
    def setup
    @chef = Chef.new(chefname: "Roberto", email: "roberto@gmail.com")
    end
  ...
  test "chefname should not be too long" do
    @chef.chefname = "x" * 50  #this creates a string with 50 exes
    assert_not @chef.valid?
  end  
  
    test "email should not be too long" do
    @chef.email = "x" * 106  #this creates a string with 106 exes
    assert_not @chef.valid?
  end  
